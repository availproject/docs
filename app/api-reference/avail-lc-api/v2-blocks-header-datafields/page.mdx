...
<Callout type="info">
**Note:** Light client must be running in `app-mode`to retrieve data. [Click here](/docs/operate-a-node/run-a-light-client/0010-light-client#setting-your-identity-using-identitytoml) to run an Avail Light Client in `app-mode`. 
</Callout>
