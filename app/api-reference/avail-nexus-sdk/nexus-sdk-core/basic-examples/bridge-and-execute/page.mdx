---
title: "Bridge and Execute with the .bridgeAndExecute() method"
---
...
The `.bridgeAndExecute()` method can be used to bridge tokens to a destination chain and then execute a smart contract function on the destination chain in a single flow.
