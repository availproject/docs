...
This page shows you how to initialize the Nexus SDK, with both the Core (headless) SDK and the UI widgets.
...
function MyComponent() {
  ...
  const handleInitialize = async () => {
    const provider = window.ethereum; // or get from your wallet library
