...
<Cards>
  <Cards.Card icon={<FilesIcon />} title="OP Stack" href="/da/build-with-avail/deploy-rollup-on-avail/Optimium/op-stack" />
  <Cards.Card icon={<FilesIcon />} title="Arbitrum Orbit stack" href="/da/build-with-avail/deploy-rollup-on-avail/Optimium/arbitrum-nitro" />
</Cards>
