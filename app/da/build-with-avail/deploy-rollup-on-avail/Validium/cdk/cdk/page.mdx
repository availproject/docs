...
The default deployment of Polygon CDK validium chain using AvailDA, is with DA attestation verification disabled over [AvailAttestation](https://github.com/availproject/cdk-zkevm-contracts/blob/avail-develop-v9.0.0-rc.6-pp/contracts/v2/consensus/validium/AvailAttestation.sol#L38) 

To learn more about DA attestation verification, follow [this](https://docs.availproject.org/da/build-with-avail/vectorx)
