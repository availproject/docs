...
<Cards>
  <Cards.Card icon={<FileIcon />} title="Transaction Lifecycle" href="/da/build-with-avail/deploy-rollup-on-avail/op-stack/overview" />
  <Cards.Card icon={<FileIcon />} title="Avail-Powered Optimium (OP Stack)" href="/da/build-with-avail/deploy-rollup-on-avail/op-stack/op-stack" />
