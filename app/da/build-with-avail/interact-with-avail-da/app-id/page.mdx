...
You can go through [this page in our docs](/da/learn-about-avail/app-ids) for a deeper understanding of how
...
<Callout type="info">
If you don't have an Avail DA wallet, you can follow our docs on [setting up a new wallet](/user-guides/accounts#creating-an-account-on-avail-da).
</Callout>
