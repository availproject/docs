...
1. [`Get Testnet Tokens`](/da/build-with-availinteract-with-avail-da/faucet): To help you get set with some `AVAIL` tokens on the Turing testnet.
2. [`Create an AppID`](/da/build-with-availinteract-with-avail-da/app-id): The guide below focusses on reading & submitting data on a particular AppID. It will help
...
To check out how to create an AppID on Avail, [refer to this page](/da/build-with-availinteract-with-avail-da/app-id).
</Callout>
