...
In this guide we will use Avail's dedicated SDKs to interact with the [Turing testnet](/da/networks).
To set up a dev environment for the SDK of your choice, please follow the steps [outlined here](/da/api-reference/avail-node-api#setting-up-the-dev-environment).
</Callout>
