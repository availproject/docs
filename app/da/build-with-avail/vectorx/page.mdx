...
<Callout type="info">  
You can check out examples on how to submit new data to Avail DA in our [API reference](/da/api-reference/avail-node-api/da-submit-data). \
...
<Callout type="info">
You can find detailed documentation on our `bridge-API` in our [API reference](/da/api-reference/avail-bridge-api).
</Callout>
