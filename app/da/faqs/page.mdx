...
please visit **[<ins>this page</ins>](/da/clash-of-nodes/faqs.mdx)**.
</Callout>
...
Avail has a strong list of strategic partnerships in place across different ecosystems. For a full list of partners, please see [Ecosystem Page](https://availproject.org/ecosystem).
New partnerships will be announced soon so follow us on [X](https://x.com/AvailProject) to keep up to date.
