...
Go to [light client API reference](/da/api-reference/avail-lc-api)
</Callout>
...
App IDs are an important concept in the context of Avail. We recommend you go through [this page in our docs](/da/learn-about-avail/app-ids) to understand how they work before moving forward.
</Callout>
