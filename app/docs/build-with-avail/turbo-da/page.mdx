...
Following this, the we will make sure your data is eventually posted to Avail DA, with you not needing to do anything else.

## How to get started

1. Every account on Turbo DA will be given a certain number of '*credits*', measured in `KBs/MBs` of data which is the amount of data they can submit to Turbo DA.
...
[API reference](/api-reference/avail-turbo-da-api) page to start leveraging the power of Turbo DA.
