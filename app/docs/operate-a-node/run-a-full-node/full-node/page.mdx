...
While the exact config of your node will depend on you unique requirements, we recommend you use at least these flags to make sure your
node can be used to access all RPC methods:
