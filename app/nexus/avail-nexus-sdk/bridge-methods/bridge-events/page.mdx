...
<Cards num={1}>
    <Cards.Card icon={<GithubIcon24 className="svg-inherit" />} title="Bridge steps" href="https://github.com/availproject/nexus-sdk/blob/develop/src/commons/types/bridge-steps.ts" target="_blank" rel="noopener noreferrer" arrow />
</Cards>
