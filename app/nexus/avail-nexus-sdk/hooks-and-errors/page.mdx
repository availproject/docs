...
<Cards num={2}>
    <Cards.Card title="nexusError.ts" icon={<GithubIcon24 className="svg-inherit"  />} href="https://github.com/availproject/nexus-sdk/blob/develop/src/sdk/ca-base/nexusError.ts" target="_blank" rel="noopener noreferrer" arrow />
    <Cards.Card title="errors.ts" icon={<GithubIcon24 className="svg-inherit"  />} href="https://github.com/availproject/nexus-sdk/blob/develop/src/sdk/ca-base/errors.ts" target="_blank" rel="noopener noreferrer" arrow />
</Cards>
    
```typescript showLineNumbers filename="Typescript"
import { ERROR_CODES } from '@avail-project/nexus';
