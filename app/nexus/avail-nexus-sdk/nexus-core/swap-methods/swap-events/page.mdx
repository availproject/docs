...
<Cards num={1}>
    <Cards.Card icon={<GithubIcon24 className="svg-inherit" />} title="Swap steps" href="https://github.com/availproject/nexus-sdk/blob/main/src/commons/types/swap-steps.ts" target="_blank" rel="noopener noreferrer" arrow />
</Cards>
