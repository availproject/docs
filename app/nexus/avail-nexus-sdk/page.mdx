...
1. [**@avail-project/nexus**](https://github.com/availproject/nexus-sdk/tree/feat/bifurcation/packages/core): Headless SDK for cross-chain operations
...
2. [**@avail-project/nexus-widgets**](https://github.com/availproject/nexus-sdk/blob/feat/bifurcation/packages/widgets): Convenient React components for plug-n-play
