...
### Bridge Balance
Under [Bridge Methods](/nexus/avail-nexus-sdk/nexus-core/bridge-methods), you can fetch [**Bridge Balance**](/nexus/avail-nexus-sdk/nexus-core/bridge-methods/fetch-bridge-balances) (previously Unified Balance). It is used to fetch token balances that can be used in bridge operations across all supported chains in one call. 
...
### Swap Methods
Within [Swap Methods](/nexus/concepts/bridge-v-swap), you can fetch [**Swap Balance**](/nexus/avail-nexus-sdk/nexus-core/swap-methods/fetch-swap-balances). It is used to to fetch token balances that can be used in swap operations across all supported chains in one call.
