...
<Cards num={2}>
    ...
    <Cards.Card title="npm page" icon={<LinkIcon />} href="https://www.npmjs.com/package/@avail-project/nexus-widgets?activeTab=readme" target="_blank" rel="noopener noreferrer" arrow />
</Cards>
