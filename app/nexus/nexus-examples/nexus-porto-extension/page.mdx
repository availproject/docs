...
## Why Add Porto Wallet?

Porto Wallet provides several advantages over the basic EIP-1193 approach:

- **Secure Authentication**: Iframe-based wallet connection for enhanced security
- **No Browser Extensions**: Works without requiring wallet browser extensions
- **Cross-Platform**: Works on desktop and mobile devices
- **User-Friendly**: Simple and intuitive wallet connection experience
