...
- Also refer to the [API reference](/nexus/avail-nexus-sdk/nexus-core/api-reference) for a complete feature list.
</Callout>
...
<Cards num={2}>
<Cards.Card title="Nexus Core SDK Reference" icon={<FileIcon />} href="/nexus/avail-nexus-sdk/nexus-core" />
<Cards.Card title="Nexus Core API Reference" icon={<FileIcon />} href="/nexus/avail-nexus-sdk/nexus-core/api-reference" />
</Cards>