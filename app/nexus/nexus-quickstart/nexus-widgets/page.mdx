...
<Callout type="info">
- For more docs on `nexus-widgets`, you can refer to the [Nexus SDK reference](/nexus/avail-nexus-sdk/nexus-widgets/).
...
You can read more about them in the [Nexus Core Quickstart](/nexus/nexus-quickstart/nexus-core) page.
