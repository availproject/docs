...
at this endpoint: [https://availproject.org/api/circulating-supply](https://availproject.org/api/circulating-supply)
</Callout>
...
For now you can refer to the Avail DA staking guide [in our docs](/user-guides/staking-governance/stake-on-avail).
