---
title: "Bridge a message from origin to destination chain"
description: "Send arbitrary messages between Avail and Ethereum using the vector_sendMessage extrinsic."
---
...
`vector_sendMessage` must be submitted directly. Wrapped bridge sends, including proxy, multisig, scheduler, and batch calls, are rejected and will fail validation.
</Callout>
