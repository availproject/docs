---
title: "Bridge tokens from origin to destination chain"
description: "Transfer AVAIL tokens between Avail and Ethereum using the vector bridge extrinsics."
---
...
Avail-to-Ethereum token bridge sends use `vector_sendMessage` and must be submitted directly. Wrapped bridge sends, including multisig, proxy, scheduler, and batch calls, are rejected.
</Callout>

## Bridge tokens from Avail DA to Ethereum

<Tabs defaultValue="avail-rust">
  <TabsList>
