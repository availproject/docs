...
You can check out [our docs here](/docs/da/operate-a-node/run-a-light-client/0010-light-client#running-the-light-client) for instructions on how to run your own light client.
</Callout>
<Callout type="warning">
**Note:**<br/> 
Light client must be running in `app-mode`to retrieve data. [Click here](/docs/da/operate-a-node/run-a-light-client/0010-light-client#setting-your-identity-using-identitytoml) for instructions on how to run an Avail Light Client in `app-mode`. 
</Callout>
<br/>
...
for an account that has some `AVAIL` tokens. You can learn how to do that [here](/docs/da/operate-a-node/run-a-light-client/0010-light-client#setting-your-identity-using-identitytoml).
