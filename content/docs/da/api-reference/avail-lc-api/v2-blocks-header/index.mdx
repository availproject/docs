---
title: "Fetch the header for a specific block if available"
image: '/img/docs-link-preview.png'
description: "Retrieve the header and DA extension for a specific block using the v2/blocks header endpoint."
---
