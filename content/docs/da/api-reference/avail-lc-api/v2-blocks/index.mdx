---
title: "Fetch specified block status and confidence if applicable"
image: '/img/docs-link-preview.png'
description: "Query block processing status and data availability confidence using the v2/blocks endpoint."
---
