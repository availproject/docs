---
title: "Fetch current status and active modes of the light client"
image: '/img/docs-link-preview.png'
description: "Retrieve light client status, active modes, and block sync progress using the v2/status endpoint."
---
