...
description: "Subscribe to real-time block and data availability events using the light client WebSocket API."
---
...
1. Access to a [running Light Client](/docs/da/operate/run-a-light-client/light-client#running-the-light-client).
