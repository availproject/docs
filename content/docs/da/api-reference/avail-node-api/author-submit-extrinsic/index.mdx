...
2. We recommend not using the latter directly either. You can read about the problems with it [in this page in our docs](/docs/da/api-reference/avail-node-api/author-submit-and-watch-extrinsic).
</Callout>