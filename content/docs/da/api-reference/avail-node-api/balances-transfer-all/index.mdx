---
title: "Transfer all funds from one account to another"
image: '/img/docs-link-preview.png'
description: "Transfer the entire balance from one account to another using the balances_transferAll extrinsic."
---
