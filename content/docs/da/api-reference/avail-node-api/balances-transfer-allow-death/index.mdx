---
title: "Transfer funds without ensuring min balance for sender"
image: '/img/docs-link-preview.png'
description: "Transfer funds allowing the sender account to be reaped using the balances_transferAllowDeath extrinsic."
---
