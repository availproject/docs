---
title: "Transfer funds while ensuring min balance for sender"
image: '/img/docs-link-preview.png'
description: "Transfer funds while preserving the sender's minimum balance using the balances_transferKeepAlive extrinsic."
---
