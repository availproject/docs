---
title: "Fetch the next available App ID on Avail DA"
image: '/img/docs-link-preview.png'
description: "Query the next unregistered App ID available for claim using the dataAvailability_nextAppId method."
---
...
You can check out [our docs for the same](/docs/da/build/interact/app-id).
</Callout>
