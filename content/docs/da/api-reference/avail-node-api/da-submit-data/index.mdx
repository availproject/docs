---
title: "Submit new data to Avail DA"
image: '/img/docs-link-preview.png'
description: "Submit application data to the Avail network using the dataAvailability_submitData extrinsic."
---
...
For instructions, [check out our docs here](/docs/da/api-reference/avail-node-api#setting-up-the-dev-environment).
...
read more [in our docs here](/docs/da/api-reference/avail-node-api/da-create-application-key).<br/>
