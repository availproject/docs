...
title: Node API
description: "Explore Avail DA's Node API endpoints for balances, staking, data availability, and nomination pools."
---
...
<Tabs defaultValue="avail-js">
  <TabsList>
    ...
    <TabsTrigger value="avail-deno">avail-deno</TabsTrigger>
...
```bash showLineNumbers filename=".env" name="cmd8"
...
You can use the [networks page](/docs/da/networks) to find endpoints for mainnet if you need to.
...
```bash showLineNumbers filename=".env" name="cmd12"
SEED="This is a random seed phrase please replace with your own"
```
...
```bash showLineNumbers filename=".env" name="cmd18"
SEED="This is a random seed phrase please replace with your own"
```
