---
title: "Create a new nomination pool with a specific pool ID"
image: '/img/docs-link-preview.png'
description: "Create a nomination pool with a chosen pool ID using the nominationPools_createWithPoolId method."
---
