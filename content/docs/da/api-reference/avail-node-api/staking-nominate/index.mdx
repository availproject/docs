---
title: "Nominate staked AVAIL tokens to one or more validators"
image: '/img/docs-link-preview.png'
description: "Nominate one or more validators with staked AVAIL tokens using the staking_nominate extrinsic."
---
