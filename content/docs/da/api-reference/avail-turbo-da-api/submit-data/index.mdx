---
title: "Submit JSON Data to Turbo DA"
image: '/img/docs-link-preview.png'
description: "Submit structured JSON data to Avail DA using the Turbo DA submit_data endpoint."
---
...
2. For submitting files or arbitrary binary data, use the [`submit_raw_data`](/docs/da/api-reference/avail-turbo-da-api/submit-raw-data) endpoint instead.
</Callout>
