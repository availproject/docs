...
---
import { Callout, Cards, Card, FileIcon } from '@/components/nextra-compat'
...
<Cards num={4}>
  <Card icon={<FileIcon />} title="Avail node API" href="/api-reference/avail-node-api" />
  <Card icon={<FileIcon />} title="Avail light client API" href="/api-reference/avail-lc-api" />
  <Card icon={<FileIcon />} title="Avail bridge API" href="/api-reference/avail-bridge-api" />
  <Card icon={<FileIcon />} title="Turbo DA API" href="/api-reference/avail-turbo-da-api" />
</Cards>
