...
title: API Reference
description: "Explore Avail DA's APIs and SDKs for node operations, light client, bridge, and Turbo DA."
---
...
<Cards num={4}>
  <Card icon={<FileIcon />} title="Avail node API" href="/docs/da/api-reference/avail-node-api" />
  <Card icon={<FileIcon />} title="Avail light client API" href="/docs/da/api-reference/avail-lc-api" />
  <Card icon={<FileIcon />} title="Avail bridge API" href="/docs/da/api-reference/avail-bridge-api" />
  <Card icon={<FileIcon />} title="Turbo DA API" href="/docs/da/api-reference/avail-turbo-da-api" />
</Cards>
