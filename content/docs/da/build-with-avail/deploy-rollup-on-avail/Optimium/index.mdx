...
<Cards>
  <Card icon={<FileIcon />} title="OP Stack" href="/docs/da/build-with-avail/deploy-rollup-on-avail/Optimium/op-stack" />
  <Card icon={<FileIcon />} title="Arbitrum Orbit stack" href="/docs/da/build-with-avail/deploy-rollup-on-avail/Optimium/arbitrum-nitro" />
</Cards>
...
This benefit however comes with a significant cost. Ethereum was not meant to be used as a DA solution and is not optimized for this use case. While work is being done to improve this, at the time of writing up to 90% of the costs paid by L2s to Ethereum is for managing data availability. High volume use cases processing a lot of transaction data, can bring these costs down significantly by using a purpose built data availability solution like [Avail](/docs/da/welcome-to-avail-docs). 
