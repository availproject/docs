...
<Cards>
  <Card icon={<FileIcon />} title="OP Stack" href="/docs/build-with-avail/deploy-rollup-on-avail/Optimium/op-stack" />
  <Card icon={<FileIcon />} title="Arbitrum Orbit stack" href="/docs/build-with-avail/deploy-rollup-on-avail/Optimium/arbitrum-nitro" />
</Cards>
