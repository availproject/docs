---
title: "Read & Write data on Avail DA"
...
1. [`Get Testnet Tokens`](/docs/da/build-with-avail/interact-with-avail-da/faucet): To help you get set with some `AVAIL` tokens on the Turing testnet.
2. [`Create an AppID`](/docs/da/build-with-avail/interact-with-avail-da/app-id): The guide below focusses on reading & submitting data on a particular AppID. It will help
...
To check out how to create an AppID on Avail, [refer to this page](/docs/da/build-with-avail/interact-with-avail-da/app-id).
</Callout>
