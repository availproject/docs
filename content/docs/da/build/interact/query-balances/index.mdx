...
description: "Query account balances on Avail DA using the TypeScript, Rust, or Go SDK."
image: '/img/docs-link-preview.png'
---

## Setting up the dev environment

In this guide we will use Avail's dedicated SDKs to interact with the [Turing testnet](/docs/da/networks).
To set up a dev environment for the SDK of your choice, please follow the steps [outlined here](/docs/da/api-reference/avail-node-api#setting-up-the-dev-environment).
...
<Tabs defaultValue="avail-mainnet">
  <TabsList>
    <TabsTrigger value="avail-mainnet">avail-mainnet</TabsTrigger>
    <TabsTrigger value="turing-testnet">turing-testnet</TabsTrigger>
  </TabsList>
  <TabsContent value="avail-mainnet">
...
```
  ...
  <TabsContent value="turing-testnet">
