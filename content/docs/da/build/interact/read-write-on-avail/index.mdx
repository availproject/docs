...
description: "Submit data to Avail DA and read it back using the TypeScript, Rust, or Go SDK."
...
1. [`Get Testnet Tokens`](/docs/da/build/interact/faucet): To help you get set with some `AVAIL` tokens on the Turing testnet.
2. [`Create an AppID`](/docs/da/build/interact/app-id): The guide below focusses on reading & submitting data on a particular AppID. It will help
...
To set up a dev environment for `avail-js`, please follow the steps [outlined here](/docs/da/api-reference/avail-node-api#setting-up-the-dev-environment).
...
To check out how to create an AppID on Avail, [refer to this page](/docs/da/build/interact/app-id).
</Callout>
