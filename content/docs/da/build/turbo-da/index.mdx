...
title: Turbo DA
description: "Get sub-250ms pre-confirmations for data submissions using Avail's Turbo DA service."
---
...
You can go through [this page in our docs for the same](/docs/da/concepts/app-ids).
</Callout>
<br/>
<div align="center">
...
[API reference](/docs/da/api-reference/avail-turbo-da-api) to start leveraging the power of Turbo DA.
