...
We have a bug bounty program where you can report the vulnerability. Please check out the [Bug Bounty](/docs/da/bug-bounty) page for detailed information on how to responsibly report it. 
