...
Avail is building the unification layer for web3, solving fundamental scaling and user experience problems. 
...
- [Use Avail DA](/docs/da/get-started) for your chain
- Run a [Validator](/docs/da/operate/become-a-validator)
- Run a [light client](/docs/da/operate/run-a-light-client)
...
We have a bug bounty program where you can report the vulnerability. Please check out the [Bug Bounty](/docs/da/build/bug-bounty) page for detailed information on how to responsibly report it. 
