...
AVAIL is the native token of the Avail network. Currently, the AVAIL token is live on Mainnet; [learn more about the AVAIL token here](/docs/da/user-guides/staking-governance/overview).
