...
you can follow our docs on [setting up a new wallet](/docs/user-guides/accounts#creating-an-account-on-avail-da).
...
So make sure you have an [Avail DA wallet set up](/docs/user-guides/accounts) before moving forward.
</Callout>
