...
you can skip to [this page](/docs/da/build-with-avail/interact-with-avail-da/app-id).
</Callout>
<Callout type="info">
**LOOKING FOR PROGRAMMATIC INSTRUCTIONS?**<br/>
You can check out our [API reference](/docs/da/api-reference/avail-node-api/da-create-application-key) for the same.
</Callout>
...
2. If you're a developer and are looking for more programmatic instructions, you can check out our [API reference](/docs/da/api-reference/avail-node-api/da-create-application-key).
