---
title: "Get started with Avail's explorers"
...
[Submit data to a particular `AppID` by submitting a `dataAvailability_submitData` extrinsic](/docs/da/learn-about-avail/app-ids#how-to-submit-data-to-my-appid).
