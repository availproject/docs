...
This method is not recommended for routine transitions between nodes. For safer alternatives, consult the [Upgrading Guide](/docs/da/operate-a-node/become-a-validator/upgrade-your-validator).
