...
sidebarTitle: Simple Deployment
...
We discussed what the command line arguments do in the [previous chapter](/docs/da/operate/become-a-validator/basics), so we won't repeat ourselves here.
...
As expected, the node is syncing new blocks. If these logs are new to you, head back to the [previous chapter](/docs/da/operate/become-a-validator/basics) where we explained in detail what they mean.
