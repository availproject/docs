...
sidebarTitle: Monitor Your Validator
...
Import the [Avail Node Metrics file](https://raw.githubusercontent.com/availproject/docs/main/static/validator_metrics.json)
<br/>
