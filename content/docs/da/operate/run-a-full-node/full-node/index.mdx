...
description: "Run an Avail full node using a pre-built binary, from source, with Docker, or via an infrastructure provider."
---
...
- Looking for a list of all available config flags? Check out the [last section of this page](/docs/da/operate/run-a-full-node/full-node#additional-configs).

</Callout>



<Tabs defaultValue="run-a-pre-built-binary">
  <TabsList>
    <TabsTrigger value="run-a-pre-built-binary">Run a pre-built binary</TabsTrigger>
    <TabsTrigger value="build-from-source">Build from source</TabsTrigger>
    <TabsTrigger value="using-docker">Using Docker</TabsTrigger>
    <TabsTrigger value="assisted-deployment">Assisted Deployment</TabsTrigger>
  </TabsList>
  <TabsContent value="run-a-pre-built-binary">
...
```
  ...
  <TabsContent value="using-docker">
...
```
  ...
  <TabsContent value="assisted-deployment">
