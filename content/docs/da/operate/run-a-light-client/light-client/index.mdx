...
sidebarTitle: Run a Light Client
...
Go to [light client API reference](/docs/da/api-reference/avail-lc-api)
</Callout>
...
App IDs are an important concept in the context of Avail. We recommend you go through [this page in our docs](/docs/da/concepts/app-ids) to understand how they work before moving forward.
</Callout>

## Running the light client

<Tabs defaultValue="light-client-mode">
  <TabsList>
    <TabsTrigger value="light-client-mode">Light-client mode</TabsTrigger>
    <TabsTrigger value="app-client-mode">App-client mode</TabsTrigger>
  </TabsList>
  <TabsContent value="light-client-mode">
...
```
  ...
  <TabsContent value="app-client-mode">
...
Detailed documentation for them can be found [in our Github repo](https://github.com/availproject/avail-light/blob/main/client/README.md#options).
  ...
  <Tabs defaultValue="apple-x8664">
  <TabsList>
    <TabsTrigger value="apple-x8664">apple-x86_64</TabsTrigger>
    <TabsTrigger value="apple-arm64">apple-arm64</TabsTrigger>
  </TabsList>
  <TabsContent value="apple-x8664">
...
<Tabs defaultValue="without-wsl">
  <TabsList>
    <TabsTrigger value="without-wsl">Without WSL</TabsTrigger>
    <TabsTrigger value="with-wsl">With WSL</TabsTrigger>
  </TabsList>
  <TabsContent value="without-wsl">
...
<Tabs defaultValue="availup">
  <TabsList>
    <TabsTrigger value="availup">availup</TabsTrigger>
    <TabsTrigger value="run-pre-built-binary">Run pre-built binary</TabsTrigger>
    <TabsTrigger value="build-from-source">Build from source</TabsTrigger>
  </TabsList>
  <TabsContent value="availup">
...
You will need to pass the full path to the `identity.toml` file if it is located elsewhere.
  ...
  <TabsContent value="run-pre-built-binary">
...
Detailed documentation for them can be found [in our Github repo](https://github.com/availproject/avail-light/blob/main/client/README.md#options).
  ...
  <TabsContent value="build-from-source">
