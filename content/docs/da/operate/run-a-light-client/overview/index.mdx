...
If you're not interested in theory, skip [to this link](/docs/da/operate/run-a-light-client/light-client) for instructions on how to run an Avail light client.
</Callout>
