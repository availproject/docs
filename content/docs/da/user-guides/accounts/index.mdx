...
<Tabs defaultValue="subwallet">
  <TabsList>
    <TabsTrigger value="subwallet">Subwallet</TabsTrigger>
    <TabsTrigger value="polkadotjs-or-talisman">PolkadotJS or Talisman</TabsTrigger>
    <TabsTrigger value="klever-wallet">Klever Wallet</TabsTrigger>
    <TabsTrigger value="nova-wallet">Nova Wallet</TabsTrigger>
    <TabsTrigger value="using-the-explorer">Using the explorer</TabsTrigger>
  </TabsList>
  <TabsContent value="subwallet">
...
3. Next, read through and agree with all of Subwallet's conditions to get the Seed Phrase of your Avail account.
<br/>
...
Please note `Avail` is short-hand for Avail DA mainnet, while the other option connects you to the Turing testnet.
...
<br/>
  ...
  <TabsContent value="polkadotjs-or-talisman">
...
<img src="/img/talisman.png" width="100%" height="100%" />
  ...
  <TabsContent value="klever-wallet">
...
<img src="/img/novaWallet/novaWallet_7.png" width="30%" height="30%" />
  ...
  <TabsContent value="using-the-explorer">
...
You can update your metadata, if needed, using the [AvailApps explorer](https://explorer.availproject.org/#/settings/metadata).
</Callout>
...
Ready to explore further? Navigate to the next guide to learn [<ins>how to use the Avail Explorer</ins>](/docs/da/user-guides/explorer) and get hands-on experience with the network.
