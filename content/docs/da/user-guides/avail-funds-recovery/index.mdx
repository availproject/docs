---
title: "Ledger Fund Recovery"
description: "Recover funds on Avail DA using the Avail recovery app for Ledger devices."
...
3. We also have a guide for [setting up a ledger account with Talisman in our docs here](/docs/da/user-guides/ledger-avail#add-your-ledger-account-to-an-extension-wallet)
</Callout>
