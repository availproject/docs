---
title: "Multisigs"
description: "Set up and manage multisig wallets on Avail DA through the AvailApps explorer."
...
Refer to our docs on [setting up an Avail wallet](/docs/da/user-guides/accounts) for more details if needed
</Callout>
...
<Tabs defaultValue="via-address-book">
  <TabsList>
    <TabsTrigger value="via-address-book">Via address book</TabsTrigger>
    <TabsTrigger value="import-a-json-file">Import a json file</TabsTrigger>
  </TabsList>
  <TabsContent value="via-address-book">
...
2. Click on `Add contact` and save any addresses you want.
  ...
  <TabsContent value="import-a-json-file">
...
Do not use multisig calls for Avail-to-Ethereum bridge sends. Bridge sends must be submitted directly with `vector_sendMessage`; wrapped bridge sends are rejected.
</Callout>
...
<Tabs defaultValue="approve">
  <TabsList>
    ...
    <TabsTrigger value="approve-and-execute">Approve and Execute</TabsTrigger>
  </TabsList>
...
2. You cannot execute the transaction without the `multisig call data` value.
  ...
  <TabsContent value="approve-and-execute">
