---
title: "Bridge AVAIL to Ethereum using the VectorX bridge"
description: "Transfer AVAIL tokens between Avail DA and Ethereum using the trust-minimized VectorX zkSNARK bridge."
...
<Callout type="warning">
Bridge transactions from Avail to Ethereum must be initiated directly from an Avail account. Do not use multisig, proxy, batch, scheduled, or other wrapped calls for bridge sends, because wrapped bridge sends are rejected.
</Callout>

<Tabs defaultValue="using-an-extension-wallet">
  <TabsList>
    <TabsTrigger value="using-an-extension-wallet">Using an extension wallet</TabsTrigger>
    <TabsTrigger value="using-a-ledger-device">Using a Ledger device</TabsTrigger>
  </TabsList>
  <TabsContent value="using-an-extension-wallet">
...
This exact process can be reversed to bridge AVAIL from Ethereum to Avail DA.
  ...
  <TabsContent value="using-a-ledger-device">
...
1. [Set up a new ledger device](/docs/da/user-guides/ledger-avail#set-up-your-ledger-from-scratch)
2. [Connect a ledger account to your Subwallet/Talisman extension wallet](/docs/da/user-guides/ledger-avail#add-your-ledger-account-to-an-extension-wallet)
