...
<Cards num={1}>
  <Card icon={<FileIcon/>} title="Proxy accounts" href="/docs/da/user-guides/proxies-on-avail/avail-proxy" />
</Cards>
...
<Cards num={1}>
  <Card icon={<FileIcon/>} title="Pure proxy accounts" href="/docs/da/user-guides/proxies-on-avail/avail-pure-proxy" />
</Cards>
