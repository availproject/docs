---
title: "AVAIL"
description: "AVAIL token overview — total supply, decimals, circulating supply, and 5% annual inflation rate."
...
You can find more information about bridging AVAIL [in our docs here](/docs/da/build/vectorx).
</Callout>
...
<br/>
<p align="center">
<img src="/img/avail-token-utility.jpg" alt="AVAIL allocation" width="100%" />
</p>
...
## The Role of $AVAIL in the Avail Ecosystem


The Avail network consists of Avail DA and Avail Nexus. Avail DA provides scalable data availability for blockchains and applications. Avail Nexus enables cross-chain coordination and execution between supported networks.
$AVAIL is the native token of the network and underpins security, usage, and economic alignment across both layers.
...
<br/>
<img src="/img/avail-token-docs.jpg" alt="Avail DA & Nexus: The coordination layer of web3" width="100%" />
...
### $AVAIL in Avail DA
    - Validators stake AVAIL to participate in block production and provide data availability guarantees.
    - Misbehaviour may result in slashing, enforcing economic accountability.
    - Applications integrated with Avail DA pay fees in AVAIL to publish data.
### $AVAIL in Avail Nexus
    - Users express cross-chain intents such as deposits, swaps, or transactions. The protocol coordinates their execution across chains.
    - Activity on Nexus generates protocol revenue. Protocol revenue may be used for AVAIL buybacks in accordance with network governance and policy.
    - Avail Nexus relies on Avail DA in the backend, increasing demand for data publication and blockspace on the network.
...
For now you can refer to the Avail DA staking guide [in our docs](/docs/da/user-guides/staking-governance/stake-on-avail).
...
<br/>
<img src="/img/avail-staking-docs.jpg" alt="Avail Staking" width="100%" />
