...
import { Callout, Cards, FileIcon } from '@/components/nextra-compat'
...
<Cards num={2}>
    <Card title="nexusError.ts" icon={<GithubIcon24 className="svg-inherit"  />} href="https://github.com/availproject/nexus-sdk/blob/develop/src/sdk/ca-base/nexusError.ts" target="_blank" rel="noopener noreferrer" arrow />
    <Card title="errors.ts" icon={<GithubIcon24 className="svg-inherit"  />} href="https://github.com/availproject/nexus-sdk/blob/develop/src/sdk/ca-base/errors.ts" target="_blank" rel="noopener noreferrer" arrow />
</Cards>
