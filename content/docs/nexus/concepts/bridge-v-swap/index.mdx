...
### Swap Methods
Within [Swap Methods](/docs/nexus/concepts/bridge-v-swap), you can fetch [**Swap Balance**](/docs/nexus/nexus-sdk/swap-methods/fetch-swap-balances). It is used to to fetch token balances that can be used in swap operations across all supported chains in one call.
