...
### Bridge Balance
Under [Bridge Methods](/docs/nexus/nexus-sdk/reference/bridge-methods/fetch-bridge-balances), you can fetch [Bridge Balance](/docs/nexus/nexus-sdk/reference/bridge-methods/fetch-bridge-balances) (previously Unified Balance). It is used to fetch token balances that can be used in bridge operations across all supported chains in one call. 
...
### Swap Methods
Within [Swap Methods](/docs/nexus/nexus-sdk/reference/swap-methods/fetch-swap-balances), you can fetch [Swap Balance](/docs/nexus/nexus-sdk/reference/swap-methods/fetch-swap-balances). It is used to to fetch token balances that can be used in swap operations across all supported chains in one call.
