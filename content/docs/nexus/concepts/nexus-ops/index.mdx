...
In Nexus, apart from [crosschain swaps](/docs/nexus/concepts/xcs-swaps), users can do ***Bridge, Transfer, Bridge & Execute*** which uses Nexus chain abstraction (aka **Bridge Methods**).
