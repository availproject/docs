...
When a user signs and authorizes an intent, a solver verifies the deposit into the Nexus contracts and instantly provides the liquidity on the destination chain. 
