...
The cookbook hosts small code snippets in a question-answer format. It does not walk you through the whole setup like the ["Build your First Liquid App"](/docs/nexus/nexus-examples) section does.
