...
The cookbook hosts small code snippets in a question-answer format. It does not walk you through the whole setup like the ["Build your First Liquid App"](/docs/nexus/nexus-sdk/get-started/installation) section does.
...
The response structure for the above example can be found [here](/docs/nexus/nexus-sdk/reference/bridge-methods/bridge#simulatebridge).

<details className="border p-3 rounded-md bg-fd-muted">
