...
``` typescript
import { IntentStatus } from '@avail-project/nexus-sdk-v2';
...
<Callout type="info">
Prefer the async standalone helper when you need this before a client exists: `import { getSupportedChains } from '@avail-project/nexus-sdk-v2/utils'` then `await getSupportedChains('mainnet')`. The client method is synchronous and uses cached deployment data.
</Callout>
...
```typescript
// Bad
const { createNexusClient } = require('@avail-project/nexus-sdk-v2');
