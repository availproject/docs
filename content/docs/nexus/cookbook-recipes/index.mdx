...
The cookbook hosts small code snippets in a question-answer format. It does not walk you through the whole setup like the ["Build your First Liquid App"](/docs/nexus/nexus-sdk/examples) section does.
...
The response structure for the above example can be found [here](/docs/nexus/nexus-sdk/bridge-methods/bridge#simulatebridge).
