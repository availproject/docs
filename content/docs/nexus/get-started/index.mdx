...
<Cards num={2}>
  ...
  <Card arrow title="Explore Nexus SDK (Headless)" href="/docs/nexus/nexus-quickstart/nexus-core">
...
<Cards num={2}>
  ...
  <Card arrow title="Bridge, Transfer, Bridge & Execute" href="/docs/nexus/concepts/nexus-ops">
  ...
  <Card arrow title="Crosschain Swaps" href="/docs/nexus/concepts/xcs-swaps">
...
<Cards>
  <Card arrow title="Bridge Methods" href="/docs/nexus/nexus-sdk/bridge-methods"/>
  <Card arrow title="Swap Methods" href="/docs/nexus/nexus-sdk/swap-methods"/>
</Cards>
