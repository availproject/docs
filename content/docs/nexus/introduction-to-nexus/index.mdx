...
<Cards num={2}>
  ...
  <Card arrow title="Explore Nexus SDK (Headless)" href="/nexus/nexus-quickstart/nexus-core">
    <img className="cardImage" src="/img/nexus-intro/sdk.png" alt="Explore Nexus SDK (Headless)" target="_blank" rel="noopener noreferrer"/>
  </Card>

  <Card arrow title="Explore Nexus Elements (UI widgets)" href="https://elements.nexus.availproject.org/docs/get-started">
...
<Cards num={2}>
  ...
  <Card arrow title="Bridge, Transfer, Bridge & Execute" href="/nexus/concepts/nexus-ops">
  ...
  <Card arrow title="Crosschain Swaps" href="/nexus/concepts/xcs-swaps">
...
<Cards>
  <Card arrow title="Bridge Methods" href="/nexus/avail-nexus-sdk/bridge-methods"/>
  <Card arrow title="Swap Methods" href="/nexus/avail-nexus-sdk/swap-methods"/>
</Cards>
