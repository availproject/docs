...
<Callout type="info">
**PREREQUISITE**<br/>
This tutorial assumes you have already completed the [basic Nexus SDK tutorial](/docs/nexus/nexus-examples/nexus-initialization-basic). 
...
Navigate to the root of your project that you created in the [basic Nexus SDK tutorial](/docs/nexus/nexus-examples/nexus-initialization-basic#initialize-the-nexus-sdk-using-next-js-a-minimal-example-using-nexus-core).
