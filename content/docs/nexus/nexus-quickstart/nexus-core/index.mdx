...
<Tabs defaultValue="git-clone">
  <TabsList>
    <TabsTrigger value="git-clone">git clone</TabsTrigger>
    <TabsTrigger value="github-cli">github CLI</TabsTrigger>
  </TabsList>
  <TabsContent value="git-clone">
```bash 
git clone https://github.com/availproject/nexus-nextjs-template
```
  </TabsContent>
  <TabsContent value="github-cli">
```bash 
...
You can read more about hooks here: [Hooks and Errors](/nexus/avail-nexus-sdk/hooks-and-errors)

```tsx title="src/components/nexus/NexusProvider.tsx"
...
Or maybe you'd like to add a pre-configured React component to your app? Check out [Nexus Elements Quickstart](/docs/nexus/nexus-ui-elements/installation).
...
- [Nexus Core SDK Reference](/nexus/avail-nexus-sdk)
- [Nexus Core API Reference](/nexus/avail-nexus-sdk/api-reference)
