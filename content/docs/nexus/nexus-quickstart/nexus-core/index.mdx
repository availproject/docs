...
<Cards num={2}>
<Card title="Nexus Core SDK Reference" icon={<FileIcon />} href="/nexus/avail-nexus-sdk" />
<Card title="Nexus Core API Reference" icon={<FileIcon />} href="/nexus/avail-nexus-sdk/api-reference" />
</Cards>