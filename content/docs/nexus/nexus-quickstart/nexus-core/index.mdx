...
<Callout type="info">
- For more docs on `nexus-core`, you can refer to the [Nexus SDK reference](/nexus/nexus-sdk).
- Also refer to the [API reference](/nexus/nexus-sdk/api-reference) for a complete feature list.
</Callout>
...
You can read more about hooks here: [Hooks and Errors](/nexus/nexus-sdk/hooks-and-errors)
...
- [Nexus Core SDK Reference](/nexus/nexus-sdk)
- [Nexus Core API Reference](/nexus/nexus-sdk/api-reference)
