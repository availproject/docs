...
<Callout type="info">
- For more docs on `nexus-core`, you can refer to the [Nexus SDK reference](/docs/nexus/nexus-sdk).
- Also refer to the [API reference](/docs/nexus/nexus-sdk/api-reference) for a complete feature list.
</Callout>
...
You can read more about hooks here: [Hooks and Errors](/docs/nexus/nexus-sdk/hooks-and-errors)
...
- [Nexus Core SDK Reference](/docs/nexus/nexus-sdk)
- [Nexus Core API Reference](/docs/nexus/nexus-sdk/api-reference)
