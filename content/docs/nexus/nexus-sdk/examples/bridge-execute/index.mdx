...
<Callout type="info">
  **PREREQUISITE**
  ...
  This tutorial builds upon the previous ["Bridge tokens using Nexus"](/docs/nexus/nexus-sdk/examples/nexus-bridge).
  Ensure you have followed up to this point with a basic project set up with Nexus SDK initialization and wallet connection before proceeding.
</Callout>
