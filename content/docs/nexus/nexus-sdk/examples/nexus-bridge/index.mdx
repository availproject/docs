---
title: "Add Bridge functionality to your RainbowKit Nexus SDK Liquid App"
...
# Add bridge token functionality to your Liquid App

<Callout type="info">
  **PREREQUISITE**

  This tutorial assumes you have already completed the [basic Nexus SDK tutorial
  with RainbowKit](/docs/nexus/nexus-sdk/examples/nexus-initialization-rainbowkit). If
