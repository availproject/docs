...
This guide builds on the [Nexus SDK Setup](/docs/nexus/nexus-sdk/get-started/nexus-sdk-setup). Complete that first.
</Callout>
...
- **`initializeWithProvider(provider)`** — your existing helper function runs `client.initialize()` and then passes the provider to `client.setEVMProvider()`
