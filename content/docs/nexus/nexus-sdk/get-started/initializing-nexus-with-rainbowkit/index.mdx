...
This guide builds on the [Nexus SDK Setup](/docs/nexus/sdk/get-started/nexus-sdk-setup). Complete that first, or scaffold a project with the [Quickstart](/docs/nexus/sdk/quickstart).
</Callout>
