...
<Cards num={1}>
    <Card icon={<GithubIcon24 className="svg-inherit" />} title="Bridge event types" href="https://github.com/availproject/nexus-sdk-v2/blob/main/src/domain/types/bridge-events.ts" target="_blank" rel="noopener noreferrer" arrow />
</Cards>
