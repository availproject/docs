...
<Callout type="info">
**Note:** Check out the [API reference](/docs/nexus/nexus-sdk/api-reference) for a full list of supported tokens and chains.
</Callout>
...
- `options`: `OnEventParam` (optional): Optional callback function to listen to the events emitted by the transfer operation.
 ...
 <Callout>
You can check out the type definitions for each step type in the [Bridge Events](/docs/nexus/nexus-sdk/bridge-methods/bridge-events) page.
</Callout>
