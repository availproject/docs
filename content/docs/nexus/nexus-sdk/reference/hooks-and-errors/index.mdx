...
See the full `SwapIntent` definition in the [SDK source](https://github.com/availproject/nexus-sdk-v2/blob/main/src/swap/types.ts).
...
The full list lives in [`src/domain/errors.ts`](https://github.com/availproject/nexus-sdk-v2/blob/main/src/domain/errors.ts). Representative codes by category:
...
<Callout type="info">
See the [full error definitions](https://github.com/availproject/nexus-sdk-v2/blob/main/src/domain/errors.ts) on GitHub for the exhaustive `ERROR_CODES` map, the named `Errors.*` factories, and every `code`.
</Callout>
