...
title: "Swap Events"
sidebarTitle: "Events"
description: "Events emitted by swapWithExactIn() and swapWithExactOut() — track swap step completion."
---
...
<Cards num={1}>
    <Card icon={<GithubIcon24 className="svg-inherit" />} title="Swap steps" href="https://github.com/availproject/nexus-sdk/blob/develop/src/commons/types/swap-steps.ts" target="_blank" rel="noopener noreferrer" arrow />
</Cards>
