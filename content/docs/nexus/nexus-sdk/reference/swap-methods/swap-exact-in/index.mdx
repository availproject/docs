...
description: "Swap tokens with an exact input amount across chains — e.g. swap 1 ETH for USDC on the destination."
---
...
2. You can check out the type definitions for each step type in the [Swap Events](/docs/nexus/nexus-sdk/reference/swap-methods/swap-events) page.
</Callout>
