...
[skills.sh](https://skills.sh) skills give AI coding agents (Codex, Claude Code, Cursor, etc.) deep context about the Nexus SDK and UI Elements.
...
The [Nexus UI Elements](https://github.com/availproject/nexus-elements) package ships skills that help agents scaffold and integrate pre-built React components.
...
Browse all skills at [skills.sh/availproject/nexus-elements](https://skills.sh/availproject/nexus-elements) and [skills.sh/availproject/nexus-sdk](https://skills.sh/availproject/nexus-sdk).
