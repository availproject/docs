...
1. You can find the SDK setup instructions in the [Quickstart](/docs/nexus/nexus-quickstart) page.
2. We also [created a tutorial](/docs/nexus/nexus-examples/nexus-initialization-basic) to make it easier to understand how devs need to initialize the Nexus SDK in their project.
</Callout>
