...
<Cards>
  <a href="https://github.com/availproject/nexus-sdk/blob/develop/src/sdk/ca-base/nexusError.ts" target="_blank" rel="noopener noreferrer" className="block no-underline h-full">
    <Card className="px-4 py-3 h-full">
      <CardTitle className="text-sm">nexusError.ts</CardTitle>
      {/* <CardDescription>nexusError.ts</CardDescription> */}
    </Card>
  </a>
  <a href="https://github.com/availproject/nexus-sdk/blob/develop/src/sdk/ca-base/errors.ts" target="_blank" rel="noopener noreferrer" className="block no-underline h-full">
    <Card className="px-4 py-3 h-full">
      <CardTitle className="text-sm">errors.ts</CardTitle>
      {/* <CardDescription>errors.ts</CardDescription> */}
    </Card>
  </a>
</Cards>
