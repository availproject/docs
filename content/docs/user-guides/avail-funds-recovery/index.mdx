...
3. We also have a guide for [setting up a ledger account with Talisman in our docs here](/docs/user-guides/ledger-avail#add-your-ledger-account-to-an-extension-wallet)
</Callout>
