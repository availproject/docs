...
1. [Set up a new ledger device](/docs/user-guides/ledger-avail#set-up-your-ledger-from-scratch)
2. [Connect a ledger account to your Subwallet/Talisman extension wallet](/docs/user-guides/ledger-avail#add-your-ledger-account-to-an-extension-wallet)
