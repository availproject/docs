...
<Callout type="info">
If you are looking for instructions on getting started with an Avail wallet, you can refer to our [accounts guide](/docs/user-guides/accounts/#creating-an-account-on-avail-da).
</Callout>
