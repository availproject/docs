...
<Cards num={1}>
  <Card icon={<FileIcon/>} title="Proxy accounts" href="/user-guides/proxies-on-avail/avail-proxy" />
</Cards>
...
<Cards num={1}>
  <Card icon={<FileIcon/>} title="Pure proxy accounts" href="/user-guides/proxies-on-avail/avail-pure-proxy" />
</Cards>
