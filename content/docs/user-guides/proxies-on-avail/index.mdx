...
You can have many different types of proxies on Avail network. Refer to [this section in our docs](/docs/user-guides/proxies-on-avail/avail-proxy#proxy-types) for more information.
</Callout>
...
<Cards num={1}>
  <Card icon={<FileIcon/>} title="Proxy accounts" href="/docs/user-guides/proxies-on-avail/avail-proxy" />
</Cards>
...
<Cards num={1}>
  <Card icon={<FileIcon/>} title="Pure proxy accounts" href="/docs/user-guides/proxies-on-avail/avail-pure-proxy" />
</Cards>

<details className="border p-3 rounded-md bg-[#EFF6FF]">
<summary><b>Why would you want a pure proxy?</b></summary>

You will see this more clearly in the [dedicated guide for setting up pure proxies](/docs/user-guides/proxies-on-avail/avail-pure-proxy), but the
