...
1. Make sure `go` is installed on your system. You can refer to [Go's docs](https://golang.org/doc/install) for the same.
...
``` bash
go get github.com/availproject/avail-go-sdk
```
</Tabs.Tab>
