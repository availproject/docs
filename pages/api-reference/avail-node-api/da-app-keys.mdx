...
You can check out [our docs for the same](/docs/end-user-guide/app-id).
</Callout>
...
<Callout type="info">
1. Think of the `dataAvailablity_appKeys` as a method that returns all the `app_ids` registered on Avail DA
