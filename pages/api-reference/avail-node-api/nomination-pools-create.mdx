...
const Alice = 'barrel thought large whisper stairs naive finish pull ginger carpet mutual sight';
...
async fn main() -> Result<(), String> {
	...
	let Alice = "barrel thought large whisper stairs naive finish pull ginger carpet mutual sight";
	let secret_uri = SecretUri::from_str(Alice).unwrap();
	let account = Keypair::from_uri(&secret_uri).unwrap();
	let amount = 1_600_000_000_000_000_000_000_00u128; // 1_60_000 Avail tokens
