...
Embark on setting up your own Avail-Optimism chain. This guide targets Ethereum's Sepolia testnet and Avail Goldberg testnet. For a detailed understanding, review the [<ins>Optimism Documentation</ins>](https://stack.optimism.io/docs/build/getting-started/#know-before-you-go).
...
- [Compile the Core Codebase](#compile-the-core-codebase)
  ...
  - [Get Access to a Sepolia Node](#get-access-to-a-Sepolia-node)
...
- [Acquire Sepolia ETH for Layer 2](#acquire-Sepolia-eth-for-layer-2)
...
2. Generate accounts:
   ...
   Record and securely store these key details. You'll need to fund `Admin`, `Proposer`, and `Batcher` with Sepolia ETH (2 ETH for `Admin`, 5 ETH for `Proposer`, 10 ETH for `Batcher`).
