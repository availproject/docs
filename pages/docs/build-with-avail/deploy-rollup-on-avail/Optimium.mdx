...
<Cards>
  <Card icon={<FilesIcon />} title="OP Stack" href="/docs/build-with-avail/deploy-rollup-on-avail/Optimium/op-stack" />
  <Card icon={<FilesIcon />} title="Arbitrum Orbit stack" href="/docs/build-with-avail/deploy-rollup-on-avail/Optimium/arbitrum-nitro" />
</Cards>
