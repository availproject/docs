...
| ------------------------------------------------------------------------ | ------------- | ------- | ------------------------ | ------------------------------------------------------------------------------------ |
| [<ins>Run a Light Client</ins>](/docs/operate-a-node/run-a-light-client/0010-light-client) | No            | No      | Basic                    | [<ins>v1.12.2-rc3</ins>](https://github.com/availproject/avail-light/releases/tag/avail-light-client-v1.12.2-rc3) |
