...
> Note: This page is under progress, we will soon add `avail-go` examples to this page, but you can still check out the [API reference](/api-reference/avail-node-api/da-create-application-key) for detailed examples in golang.
