...
Head on over to the [accounts section of the Avail explorer](https://explorer.avail.so/#/accounts) and connect your main account.
...
### Trying to Transfer Funds via Proxy
...
### Trying to Stake via Proxy

1. Go to the [extrinsics section of the Avail explorer](https://explorer.avail.so/#/extrinsics).
...
7. This time you will see that the transaction a actually goers through and `1000 AVAIL`
