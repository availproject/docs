...
1. Go to the [settings tab of the Avail apps explorer](https://explorer.avail.so/#/settings).
...
3. Go to the [accounts tab of the Avail apps explorer](https://explorer.avail.so/#/accounts).
