...
The Avail team has been hard at work in partnership with [Succint labs](https://succinct.xyz/)
...
You can read about VectorX in more detail on [Succint's blog](https://blog.succinct.xyz/vector-x/).
...
Go to [bridge-ui-xi.vercel.app](https://bridge-ui-xi.vercel.app/), and then connect an Avail wallet,
and an EVM wallet to the website.

<Callout type="info">
Please notethat this is required because Avail DA and Ethereum use two different address formats.
