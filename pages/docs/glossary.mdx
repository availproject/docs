...
AVAIL is the native token of the Avail network. Currently, there is no publicly available "AVAIL" token with monetary value; it is solely used for testnet purposes.
