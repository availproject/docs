...
To achieve this, Avail has been building out Avail's Unification Layer, a unifying tech stack starting with the foundational Data Availability (DA) layer, 
...
<img src="/img/unification-layer-graphic-updated.png" alt="Avail-unification-layer" width="100%"/>
...
Read more about each of these layers in the following pages. You can also read more about Avail's vision and overall mission [on our blog](https://blog.availproject.org/the-avail-vision-accelerating-the-unification-of-web3).