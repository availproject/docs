...
Our first step is to obtain the prebuilt binary for Avail Node. [We offer a wide range of prebuilds](https://github.com/availproject/avail/releases/tag/v2.2.4.1), but in case you don't see your Linux flavor or architecture here, head to the FAQ chapter to learn how to build your own executable.
