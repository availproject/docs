...
> - **Controller Account:** Choose your Controller account, which only requires a minimal amount of AVAIL to initiate and cease validation.
> - **Value Bonded:** Specify the quantity of AVAIL tokens you wish to bond from your Stash account. You can stake any amount that exceeds the minimum requirement.
