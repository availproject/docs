...
| ------------- | --------------------------------------------------------- | ---------------------------------------------------------------------------------- |
| **Full Node** | [<ins>avail</ins>](https://github.com/availproject/avail) | [<ins>v2.1.0.0-rc1</ins>](https://github.com/availproject/avail/releases/tag/v2.1.0.0-rc1) |
...
2. Alternatively, in your old terminal, run `source $HOME/.cargo/env` and then run `source $HOME/.cargo/env` again.
  ...
  If you encounter any issues with the Rust installation, refer to the [Rust installation guide](https://www.rust-lang.org/tools/install) for troubleshooting tips.
2. Make sure your Linux distro is up-to-date by running:
```bash
sudo apt update && sudo apt upgrade
```

3. Install some common dependencies using:
```bash
