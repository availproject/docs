...
App IDs are an important concept in the context of Avail. We recommend you go through [this page in our docs](/docs/end-user-guide/app-id) to understand how they work before moving forward.
</Callout>
