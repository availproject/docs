...
run [`v1.11.0`](https://github.com/availproject/avail-light/releases/tag/v1.11.0) of the Avail light client for maximal network support. <br/>
...
<Tabs.Tab>
  ...
  1. Download the [recommended version of the binary](https://github.com/availproject/avail-light/releases/tag/v1.11.0) that is compatible with your operating system.
...
1. Go to the [releases page of the Avail light client repo](https://github.com/availproject/avail-light/releases/tag/v1.11.0), and download the
