...
run [`v1.12.2-rc3`](https://github.com/availproject/avail-light/releases/tag/avail-light-client-v1.12.2-rc3) of the Avail light client for maximal network support. <br/>
...
This data can then be accessed via a loacal HTTP endpoint.

<Callout type="info">
**WE RECOMMEND LEARNING ABOUT APP IDs on AVAIL DA**<br/>
App IDs are an important concept in the context of Avail. We recommend you go through [this page in our docs](/docs/build-with-avail/interact-with-avail-da/app-id) to understand how they work before moving forward.
</Callout>
...
Detailed documentation for them can be found [in our Github repo](https://github.com/availproject/avail-light/blob/main/client/README.md#options).
  ...
  1. Download the [recommended version of the binary](https://github.com/availproject/avail-light/releases/tag/avail-light-client-v1.12.2-rc3) that is compatible with your operating system.
...
1. Go to the [releases page of the Avail light client repo](https://github.com/availproject/avail-light/releases/tag/avail-light-client-v1.12.2-rc3), and download the
