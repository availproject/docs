...
run [`v1.11.1`](https://github.com/availproject/avail-light/releases/tag/avail-light-client-v1.11.1) of the Avail light client for maximal network support. <br/>
...
<Tabs.Tab>
  ...
  1. Download the [recommended version of the binary](https://github.com/availproject/avail-light/releases/tag/avail-light-client-v1.11.1) that is compatible with your operating system.
  ...
  ```sh
  ./avail-light-linux-amd64 --network turing
  ```
  </Tabs.Tab>
  ...
  ```sh
  ./avail-light-apple-x86_64 --network turing
  ```
  </Tabs.Tab>
  ...
  ```sh
  ./avail-light-apple-arm64 --network turing
  ```
  </Tabs.Tab>
...
1. Go to the [releases page of the Avail light client repo](https://github.com/availproject/avail-light/releases/tag/avail-light-client-v1.11.1), and download the
