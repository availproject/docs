...
We highly recomment you keep a small unstaked balance that you might need to initiate any other transactions.
</Callout>
...
You can view a list of all available pools by going to [staking.avail.tools/#/pools](https://staking.avail.tools/#/pools)
...
Go to [staking.avail.tools/#/pools](https://staking.avail.tools/#/pools) and make sure you have connected a wallet
...
[docs here](/docs/stake-on-avail/direct-nomination#choose-your-validators) for reference.
