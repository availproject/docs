...
3. Check your eligibility by going to the Avail Claims Portal, accepting the Avail Mainnet Terms & Conditions and the supplemental Airdrop Terms & Conditions as well as following the claims process
</Callout>
...
To be able to claim your tokens from Avail's unification drop, you will need an Avail wallet address that you have access to.
...
3. Next, follow these instructions on the claims portal to claim your rewards based on the categories you are elibile for:

### To claim your Clash of Nodes or Light Client challenge rewards:
<br/>
<img src="/img/claims-ui/claims-1.png" alt="Avail Unification Drop" />
    ...
    - Lastly, you will get a final pop-up message where you will need to confirm your claim.
    <br/>
...
### To claim your rewards with your Ethereum-compatible or Starkware wallets:
