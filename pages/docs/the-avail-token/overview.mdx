...
| Circulating Supply at genesis | 16.7% of total supply                                                                       |
...
`**` Public Allocation (Future Initiatives) category is unlocked and not circulating to be used in future campaigns.
</Callout>
