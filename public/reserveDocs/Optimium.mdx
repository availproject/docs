...
<Cards>
  <Card icon={<FilesIcon />} title="OP Stack" href="/da/build-with-avail/deploy-rollup-on-avail/op-stack" />
  <Card icon={<FilesIcon />} title="Arbitrum Orbit stack" href="/da/build-with-avail/Optimium/arbitrum-nitro" />
</Cards>
...
This benefit however comes with a significant cost. Ethereum was not meant to be used as a DA solution and is not optimized for this use case. While work is being done to improve this, at the time of writing up to 90% of the costs paid by L2s to Ethereum is for managing data availability. High volume use cases processing a lot of transaction data, can bring these costs down significantly by using a purpose built data availability solution like [Avail](/da/introduction-to-avail-da). 
