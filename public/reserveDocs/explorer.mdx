...
<br/>
<img src="/img/avail-da-mainnet-explorer.png" width="100%" height="100%" />
...
<br/>
<img src="/img/block-height.png" width="100%" height="100%" />


## Manage Accounts

The explorer allows you to create, manage, and recover accounts. You can also initiate transactions, stake tokens, and more. To learn how to create an account, check out the [<ins>Create and Manage Accounts guide</ins>](/user-guides/accounts).
