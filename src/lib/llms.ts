...
export function generateLlmsTxt(): string {
  ...
  const lines: string[] = [
    ...
    "- [Networks & endpoints](/docs/da/build/networks): RPC URLs, chain specs, contract addresses",
    ...
    "- [Nexus concepts](/docs/nexus/concepts): Architecture, intents, and solvers",
    ...
    "- [Swap methods](/docs/nexus/nexus-sdk/swap-methods): Cross-chain swap functions",
    "- [Nexus UI Elements](/docs/nexus/nexus-ui-elements): Pre-built React components",
    "- [Cheat sheet](/docs/nexus/cheat-sheet): Quick reference for Nexus development",
