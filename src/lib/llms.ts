...
export function generateLlmsTxt(): string {
  ...
  const lines: string[] = [
    ...
    "- [Nexus SDK setup](/docs/nexus/nexus-sdk/get-started/nexus-sdk-setup): Set up the SDK and make your first cross-chain call",
    ...
    "- [Widgets](/docs/nexus/widgets): Pre-built React components",
